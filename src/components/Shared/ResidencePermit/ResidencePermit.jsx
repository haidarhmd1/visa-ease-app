      ...
      >
        <Layout style={style.container}>
          <View style={style.container}>
            <Text variant='headlineMedium' style={style.centerText}>Residence Permit Guidelines</Text>
            <Spacer />
            <Divider />
            <Spacer />
            <ScrollView>
