      ...
      >
        <Layout style={style.container}>
          <View style={style.container}>
            <Text variant='headlineMedium' style={style.centerText}>Biometric Image Guidelines</Text>
            <Spacer />
            <Divider />
            <Spacer />
            <ScrollView>
